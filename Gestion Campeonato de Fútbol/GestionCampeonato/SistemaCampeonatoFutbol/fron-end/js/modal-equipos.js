document.querySelector(".btn-secondary").addEventListener("click", function () {
  ...
  const listaEquiposModal = document.getElementById(
    "equipos-registrados-modal"
  );
  ...
  document
    .querySelectorAll(".eliminar-equipo")
    .forEach(function (eliminarBoton) {
      eliminarBoton.addEventListener("click", function () {
        ...
        if (nuevoEquipoItem) {
          equipoItemModal.parentNode.removeChild(nuevoEquipoItem);
        }
        actualizarListaEquipos();
      });
    });
